 ...
 */
namespace Vespolina\CommonBundle\Tests\Model;

use Vespolina\CommonBundle\Model\CreditCardProfile;
...
class CreditCardProfileTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $profile = $this->getMockForAbstractClass('Vespolina\CommonBundle\Model\CreditCardProfile');
